    ...
    <Page className="w-full flex-1">
      ...
      <View className="w-full flex-row justfy-around items-center mt-5 gap-2">
        <View className="gap-5 p-2.5">
          <Button text="Alterar dados" className="w-[190px] h-[50px] flex items-center justify-center text-center" onPress={() => changeState("view")} />
        ...
        <View className="w-[187px] h-[120px] bg-[#EDEDED] rounded-lg flex items-center justify-center">
          <Text className="text-[60px] font-inter-regular text-center">90 bpm</Text>
        </View>
      </View>
    </Page>
  );
